...
var object_cjs = require('./object.cjs');

var __defProp = Object.defineProperty;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });
function isPromiseLike(value) {
  return remeda.isPromise(value) || remeda.isFunction(object_cjs.getProp(value, [
    "then"
  ]));
}
...
exports.asyncProperties = asyncProperties;
exports.emitterToGenerator = emitterToGenerator;
