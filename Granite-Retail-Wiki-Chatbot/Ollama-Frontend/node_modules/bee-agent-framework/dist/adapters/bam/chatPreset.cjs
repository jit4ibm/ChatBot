...
const BAMChatLLMPreset = {
  "meta-llama/llama-3-3-70b-instruct": /* @__PURE__ */ __name(() => {
    const { template, parameters, messagesToPrompt } = llmChatTemplates_cjs.LLMChatTemplates.get("llama3.3");
    return {
      base: {
        parameters: {
  ...
  "meta-llama/llama-3-1-70b-instruct": /* @__PURE__ */ __name(() => {
    const { template, parameters, messagesToPrompt } = llmChatTemplates_cjs.LLMChatTemplates.get("llama3.1");
    return {
      base: {
        parameters: {
          decoding_method: "greedy",
  ...
  "meta-llama/llama-3-70b-instruct": /* @__PURE__ */ __name(() => {
    const { template, parameters, messagesToPrompt } = llmChatTemplates_cjs.LLMChatTemplates.get("llama3");
    return {
      base: {
        parameters: {
          decoding_method: "greedy",
...
exports.BAMChatLLMPreset = BAMChatLLMPreset;
