...
var customsearch = require('@googleapis/customsearch');
...
class GoogleSearchToolOutput extends base_cjs.SearchToolOutput {
  static {
...
class GoogleSearchTool extends base_cjs$1.Tool {
  static {
  ...
  constructor(options = {
    ...
    super(options);
    this.apiKey = options.apiKey || env_cjs.parseEnv("GOOGLE_API_KEY", zod.z.string());
    this.cseId = options.cseId || env_cjs.parseEnv("GOOGLE_CSE_ID", zod.z.string());
  ...
  get client() {
    return new customsearch.customsearch_v1.Customsearch({
      auth: this.apiKey
    });
  }
  static {
...
_ts_decorate([
  decoratorCache_cjs.Cache(),
  _ts_metadata("design:type", typeof customsearch.customsearch_v1 === "undefined" || typeof customsearch.customsearch_v1.Customsearch === "undefined" ? Object : customsearch.customsearch_v1.Customsearch),
  _ts_metadata("design:paramtypes", [])
], GoogleSearchTool.prototype, "client", null);

exports.GoogleSearchTool = GoogleSearchTool;
exports.GoogleSearchToolOutput = GoogleSearchToolOutput;
//# sourceMappingURL=googleSearch.cjs.map
//# sourceMappingURL=googleSearch.cjs.map