...
var Task = class _Task {
  constructor(input) {
    ...
    input?.signal?.addEventListener?.("abort", () => {
      this.reject(new TaskDestroyedException("Task has been aborted!"));
    }, {
      once: true
    });
  }
  static resolve(value) {
    const instance = new _Task();
...
function isDeletable(value) {
  return typeof value === "object" && value !== null && "destructor" in value && typeof value.destructor === "function";
}
...
var SlidingTaskMap = class extends TaskMap {
  constructor(windowSize, ttl) {
    ...
    if (ttl !== void 0 && ttl !== Number.POSITIVE_INFINITY) {
      if (isNaN(ttl) || ttl < 1) {
...
export { SlidingTaskMap, Task, TaskDestroyedException, TaskMap, TaskQueue, TaskState, isDeletable };
