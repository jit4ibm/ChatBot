...
declare function isDeletable(value: unknown): value is Deletable;
...
declare class Task<T, E = any> implements Promise<T>, Deletable {
    ...
    static resolve<A>(value: A): Task<A, any>;
...
declare class TaskMap<K, V> extends Map<K, V> {
    delete(key: K): boolean;
    set(key: K, value: V): this;
    clear(): void;
}

declare class SlidingTaskMap<K, V> extends TaskMap<K, V> {
...
export { Deletable, SlidingTaskMap, Task, TaskDestroyedException, TaskInput, TaskMap, TaskQueue, TaskState, isDeletable };
