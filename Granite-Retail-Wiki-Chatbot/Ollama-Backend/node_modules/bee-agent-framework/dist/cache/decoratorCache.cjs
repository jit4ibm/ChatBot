...
function Cache(_options) {
  const baseOptions = {
    ...
    ttl: Infinity,
    enumerable: false,
    ...R__namespace.pickBy(_options ?? {}, R__namespace.isDefined)
  };
...
Cache.getInstance = /* @__PURE__ */ __name(function getInstance(target, property) {
  const descriptor = prototype_cjs.findDescriptor(target, property);
  if (!descriptor) {
...
const WeakRefKeyFn = (() => {
  ...
  const fn = /* @__PURE__ */ __name((...args) => {
    const chunks = args.map((value) => {
      if (R__namespace.isObjectType(value) || R__namespace.isFunction(value)) {
        if (!_lookup.has(value)) {
          _lookup.set(value, hash_cjs.createRandomHash(6));
        }
        return _lookup.get(value);
      }
      return value;
    });
    return hash_cjs.createHash(JSON.stringify(chunks));
  }, "fn");
  fn.from = (cb) => {
    return function() {
...
const ObjectHashKeyFn = /* @__PURE__ */ __name((...args) => hash__default.default(args, {
  encoding: "base64",
  replacer: /* @__PURE__ */ (() => {
    const _lookup = /* @__PURE__ */ new WeakMap();
    return (value) => {
...
exports.JSONCacheKeyFn = JSONCacheKeyFn;
exports.ObjectHashKeyFn = ObjectHashKeyFn;
exports.SingletonCacheKeyFn = SingletonCacheKeyFn;
exports.WeakRefKeyFn = WeakRefKeyFn;
//# sourceMappingURL=decoratorCache.cjs.map
//# sourceMappingURL=decoratorCache.cjs.map