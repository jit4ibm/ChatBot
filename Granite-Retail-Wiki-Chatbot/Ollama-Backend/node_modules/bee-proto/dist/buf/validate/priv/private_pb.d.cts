...
import { Message, PartialMessage, proto3, FieldList, BinaryReadOptions, JsonValue, JsonReadOptions, PlainMessage, FieldOptions } from '@bufbuild/protobuf';
 ...
 */
declare class Constraint extends Message<Constraint> {
    /**
...
export { Constraint, FieldConstraints, field };
