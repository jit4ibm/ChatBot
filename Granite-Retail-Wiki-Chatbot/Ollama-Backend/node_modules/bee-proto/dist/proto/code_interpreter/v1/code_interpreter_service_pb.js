...
class ExecuteResponse extends Message {
  /**
...
class ParseCustomToolRequest extends Message {
  /**
...
class ParseCustomToolResponseSuccess extends Message {
  /**
...
class ParseCustomToolResponseError extends Message {
  /**
...
class ParseCustomToolResponse extends Message {
  /**
...
class ExecuteCustomToolRequest extends Message {
  /**
   * @generated from field: string executor_id = 1;
   */
  executorId = "";
...
class ExecuteCustomToolResponseSuccess extends Message {
  /**
...
class ExecuteCustomToolResponseError extends Message {
  /**
...
class ExecuteCustomToolResponse extends Message {
  /**
...
//# sourceMappingURL=code_interpreter_service_pb.js.map